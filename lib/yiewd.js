...
Driver.prototype._setInnerDriver = function(driver) {
  this.driver = driver;
  this.iterator = this.generator.apply(this, [this]);
...
Driver.prototype.run = function(generator) {
  this.generator = generator;
  this.iterator = this.generator.apply(this);
  this.iterator.next();
};

Driver.prototype.sleep = function(secs) {
  setTimeout(function() {
    this.iterator.next();
  }.bind(this), secs * 1000);
};

Driver.prototype.reportStatus = function(passed) {
  if (this.sauce === null) {
    this.iterator.throw(new Error("Status reporting is for Sauce Labs tests"));
    return;
  }
  this.sauce.updateJob(this.driver.sessionID, {passed: passed}, function(err, res) {
    if (err) {
      this.iterator.throw(err);
      return;
    }
...
Driver.prototype.reportPass = function() {
  this.reportStatus(true);
};

Driver.prototype.reportFail = function() {
