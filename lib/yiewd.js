...
wd.addPromiseChainMethod('run', function(gen) {
  // todo: how do you check that it is finished?
  return Q.fcall(run, gen, this);
});
...
yiewd.remote = function() {
  ...
  return wd.promiseChainRemote.apply(wd, args);
};
