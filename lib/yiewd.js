...
Driver.prototype.reportStatus = o0(function*(passed) {
  if (this.sauce === null) {
...
Driver.prototype.reportPass = o0(function*() {
  yield this.reportStatus(true);
});

Driver.prototype.reportFail = o0(function*() {
  yield this.reportStatus(false);
});

Driver.prototype.sleep = o0(function*(secs) {
  var cb = oC();
